...
const blockEngineBuilder: ProjectItemData = {
  ...
  path: ProjectID.BLOCK_ENGINE_BUILDER,
  description:
...
const bahnhofWatchdog: ProjectItemData = {
  ...
  path: ProjectID.BAHNHOF_WATCHDOG,
  description:
